...
public class Example_Two_EventHandler {
    public static void main(String[] args) throws Exception {
        ...
        EventHandler<Element> handler1 = new EventHandler<Element>() {
            ...
            public void onEvent(Element element, long sequence, boolean endOfBatch) throws InterruptedException {
                System.out.println("handler1-Element: " + Thread.currentThread().getName() + ": " + element.getValue() + ": " + sequence);
//                Thread.sleep(10000000);
        ...
        EventHandler<Element> handler2 = new EventHandler<Element>() {
            @Override
            public void onEvent(Element element, long sequence, boolean endOfBatch) throws InterruptedException {
                System.out.println("handler2-Element: " + Thread.currentThread().getName() + ": " + element.getValue() + ": " + sequence);
//                Thread.sleep(10000000);
            }
        };
