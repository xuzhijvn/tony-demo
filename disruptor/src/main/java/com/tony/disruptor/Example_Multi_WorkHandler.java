...
public class Example_Multi_WorkHandler {
...
//                Thread.sleep(10000000);
        ...
        WorkHandler<Element> workHandler1 = new WorkHandler<Element>() {
            @Override
            public void onEvent(Element element) throws Exception {
                System.out.println("workHandler1-Element: " + Thread.currentThread().getName() + ": " + element.getValue());
            }
        };

        WorkHandler<Element> workHandler2 = new WorkHandler<Element>() {
            @Override
            public void onEvent(Element element) throws Exception {
                System.out.println("workHandler2-Element: " + Thread.currentThread().getName() + ": " + element.getValue());
            }
        };
