...
public class RedisLockConfiguration {
    ...
    public RedisLockRegistry redisLockRegistry(RedisConnectionFactory redisConnectionFactory) {
        return new RedisLockRegistry(redisConnectionFactory, "lock-key-prefix");
    }

    @Bean
    public RedisTemplate<Object, Object> getRedisTemplate(RedisConnectionFactory lettuceConnectionFactory) {
