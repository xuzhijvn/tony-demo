...
@Service
@CacheConfig(cacheNames="test")// cacheName 是一定要指定的属性，可以通过 @CacheConfig 声明该类的通用配置
public class UserService {
    ...
    /**
     * 将结果缓存，当参数相同时，不会执行方法，从缓存中取,不指定key
     *
     * @param id
     * @return
     */
    ...
    public User findUserById2(Integer id) {
        System.out.println("===> findUserById2(id), id = " + id);
        return new User(id, "tony");
    }
